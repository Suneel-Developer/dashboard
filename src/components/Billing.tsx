...
const Step04: React.FC<Billing> = ({ onFinish, onPrevious }) => {
  return (
    <div className="p-6 w-4/5">
      <h1 className="text-2xl font-semibold">Select Plan</h1>
      <p className="text-text font-normal text-sm mb-2">
      ...
      <div className="flex justify-between gap-2 my-3 ">
        <div className=" border border-secondary rounded text-center p-3">
          ...
          <div className="flex justify-center align-middle gap-2 my-1">
            <span className="text-dark_text">$</span>
          ...
          <input
            type="radio"
            className="border-secondary border-5 rounded-full"
          />
        </div>
      ...
      <h1 className="text-2xl font-semibold mb-1">Payment Information</h1>
      ...
      <form action="#">
        ...
        <div className="flex justify-between gap-2 mt-4 text-sm text-text">
          ...
          <button
            type="submit"
            onClick={onFinish}
            className=" flex justify-center items-center gap-3 w-32 bg-success text-white font-normal py-3 rounded-md "
          >
            Finish
          </button>
        </div>
